...
def test_compose_post_minimal():
    blocks = {
        ...
        "prompts": {
            "skeleton": {"sections": ["hook","exec_pov","proof_point","micro_plays","quote","cta","hashtags"]},
            "section_templates": {}
        },
        "hashtags": {"graham_core": ["#a","#b","#c"]}
    }
    p = compose_post("graham_thought_leadership", blocks, {"quote":"q","author":"a","source":"s"}, {"metric":"m","value":"1","unit":"","source":"src","date":"2025"})
